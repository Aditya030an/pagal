    ...
    <section className="bg-[#F4F9FC] min-h-screen">
      ...
      <div className="max-w-[1440px] mx-auto px-6 sm:px-12 lg:px-24 pb-32">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-16">
          {blogs.map((blog) => (
            <article key={blog.id} className="group relative rounded-3xl bg-white/70 backdrop-blur-xl shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden">
              {/* Admin Actions */}
              {isAdmin && (
