      ...
      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24">
          ...
          <form
            ...
            className="relative bg-white/70 backdrop-blur-xl border border-[#E5E1DA] rounded-[32px] p-12 space-y-10"
          >
            <input
              type="text"
              name="user_name"
              ...
              required
              disabled={loading}
              className="w-full bg-transparent border-b py-4 outline-none disabled:opacity-50"
            />
            ...
            <button
              type="submit"
              disabled={loading}
              className="group flex items-center gap-6 pt-4 disabled:opacity-60"
            >
              {loading ? (
                <span className="flex items-center gap-3">
                  <span className="h-5 w-5 border-2 border-[#7B5A4A] border-t-transparent rounded-full animate-spin" />
                  Sending...
                </span>
              ) : (
                <>
